...
#pragma warning(pop)
  ...
  inline NtQueryVolumeInformationFile_t NtQueryVolumeInformationFile;
  inline NtOpenDirectoryObject_t NtOpenDirectoryObject;
  inline NtQueryAttributesFile_t NtQueryAttributesFile;
  inline NtOpenFile_t NtOpenFile;
  inline NtCreateFile_t NtCreateFile;
  inline NtReadFile_t NtReadFile;
  inline NtReadFileScatter_t NtReadFileScatter;
  inline NtWriteFile_t NtWriteFile;
  inline NtWriteFileGather_t NtWriteFileGather;
  inline NtCancelIoFileEx_t NtCancelIoFileEx;
  inline NtDeleteFile_t NtDeleteFile;
  inline NtClose_t NtClose;
  inline NtQueryEaFile_t NtQueryEaFile;
  inline NtSetEaFile_t NtSetEaFile;
  inline NtCreateNamedPipeFile_t NtCreateNamedPipeFile;
  inline NtQueryDirectoryFile_t NtQueryDirectoryFile;
  inline NtSetInformationFile_t NtSetInformationFile;
  inline NtWaitForSingleObject_t NtWaitForSingleObject;
  inline NtWaitForMultipleObjects_t NtWaitForMultipleObjects;
  inline NtDelayExecution_t NtDelayExecution;
  inline NtSetIoCompletion_t NtSetIoCompletion;
  inline NtRemoveIoCompletion_t NtRemoveIoCompletion;
  inline NtRemoveIoCompletionEx_t NtRemoveIoCompletionEx;
  inline NtLockFile_t NtLockFile;
  inline NtUnlockFile_t NtUnlockFile;
  inline NtCreateSection_t NtCreateSection;
  inline NtOpenSection_t NtOpenSection;
  inline NtQuerySection_t NtQuerySection;
  inline NtExtendSection_t NtExtendSection;
  inline NtMapViewOfSection_t NtMapViewOfSection;
  inline NtUnmapViewOfSection_t NtUnmapViewOfSection;
  inline NtFlushBuffersFile_t NtFlushBuffersFile;
  inline NtFlushBuffersFileEx_t NtFlushBuffersFileEx;
  inline NtSetSystemInformation_t NtSetSystemInformation;
  ...
  inline RtlGenRandom_t RtlGenRandom;
  inline OpenProcessToken_t OpenProcessToken;
  inline LookupPrivilegeValue_t LookupPrivilegeValue;
  inline AdjustTokenPrivileges_t AdjustTokenPrivileges;
  inline PrefetchVirtualMemory_t PrefetchVirtualMemory_;
  inline DiscardVirtualMemory_t DiscardVirtualMemory_;
  inline GetPerformanceInfo_t GetPerformanceInfo;
  inline SymInitialize_t SymInitialize;
  inline SymGetLineFromAddr64_t SymGetLineFromAddr64;
  inline RtlCaptureStackBackTrace_t RtlCaptureStackBackTrace;
  inline RtlDosPathNameToNtPathName_U_t RtlDosPathNameToNtPathName_U;
  inline RtlUTF8ToUnicodeN_t RtlUTF8ToUnicodeN;
  inline RtlUnicodeToUTF8N_t RtlUnicodeToUTF8N;
  inline RtlAnsiStringToUnicodeString_t RtlAnsiStringToUnicodeString;
  inline RtlUnicodeStringToAnsiString_t RtlUnicodeStringToAnsiString;
  inline RtlOemStringToUnicodeString_t RtlOemStringToUnicodeString;
  inline RtlUnicodeStringToOemString_t RtlUnicodeStringToOemString;
  inline RtlFreeUnicodeString_t RtlFreeUnicodeString;
  inline RtlFreeAnsiString_t RtlFreeAnsiString;

  inline BaseGetNamedObjectDirectory_t BaseGetNamedObjectDirectory;
