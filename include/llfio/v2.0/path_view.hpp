...
public:
  ...
  */
  ...
  private:
    ...
    static_assert(_is_allocator_based<void> + _is_deleter_based<void> == 1, "AllocatorOrDeleter must be either a callable deleter, or a STL allocator, for value_type");
